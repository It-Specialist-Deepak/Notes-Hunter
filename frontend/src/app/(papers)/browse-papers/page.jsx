...
export default function BrowsePaperPage() {
 ...
 text-white overflow-hidden">
                        ...
                        {/* SEARCH */}
                          <div className="flex items-center gap-3 bg-white/10 backdrop-blur-2xl border border-white/20 rounded-full p-4 max-w-xl"> 
                                               <Search className="ml-4 text-white/60" size={20} />
                                                ...
                                                placeholder="Search Papers, PDFs" className="flex-1 bg-transparent outline-none px-2 text-sm text-white" />
                                                </div>
                    </div>
            ...
            <section className="pb-16 px-4">
                <div className="max-w-7xl mx-auto">
                    <PapersCategory searchTerm={searchTerm} />
                </div>
            </section>
